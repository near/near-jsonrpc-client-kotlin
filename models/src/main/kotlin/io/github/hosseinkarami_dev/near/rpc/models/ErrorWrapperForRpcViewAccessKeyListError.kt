...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcViewAccessKeyListErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcViewAccessKeyListErrorSerializer::class)
public sealed class ErrorWrapperForRpcViewAccessKeyListError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcViewAccessKeyListError,
    /**
