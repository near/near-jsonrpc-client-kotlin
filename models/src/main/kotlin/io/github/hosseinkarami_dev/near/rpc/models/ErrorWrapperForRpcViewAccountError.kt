...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcViewAccountErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcViewAccountErrorSerializer::class)
public sealed class ErrorWrapperForRpcViewAccountError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcViewAccountError,
    /**
