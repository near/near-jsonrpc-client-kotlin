...
object GlobalContractIdentifierSerializer : KSerializer<GlobalContractIdentifier> {
    private val union: BlindUnionSerializer<GlobalContractIdentifier> = BlindUnionSerializer(
        ...
        variants = listOf(
            Variant(serialName = "hash", kind = VariantKind.WRAPPED, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.GlobalContractIdentifier.Hash }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.GlobalContractIdentifier.Hash>() as KSerializer<Any?>, valueSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.CryptoHash>() as KSerializer<Any?>, valueGetter = { (it as io.github.hosseinkarami_dev.near.rpc.models.GlobalContractIdentifier.Hash).hash }, valueBuilder = { io.github.hosseinkarami_dev.near.rpc.models.GlobalContractIdentifier.Hash(it as io.github.hosseinkarami_dev.near.rpc.models.CryptoHash) }, fields = listOf("hash")),
            Variant(serialName = "account_id", kind = VariantKind.WRAPPED, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.GlobalContractIdentifier.AccountId }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.GlobalContractIdentifier.AccountId>() as KSerializer<Any?>, valueSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.AccountId>() as KSerializer<Any?>, valueGetter = { (it as io.github.hosseinkarami_dev.near.rpc.models.GlobalContractIdentifier.AccountId).accountId }, valueBuilder = { io.github.hosseinkarami_dev.near.rpc.models.GlobalContractIdentifier.AccountId(it as io.github.hosseinkarami_dev.near.rpc.models.AccountId) }, fields = listOf("account_id"))
        )
    )
