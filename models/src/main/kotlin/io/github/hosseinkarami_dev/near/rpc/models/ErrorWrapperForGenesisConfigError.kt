...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForGenesisConfigErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForGenesisConfigErrorSerializer::class)
public sealed class ErrorWrapperForGenesisConfigError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: GenesisConfigError,
    /**
