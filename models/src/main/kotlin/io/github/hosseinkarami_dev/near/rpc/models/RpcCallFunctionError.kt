...
import io.github.hosseinkarami_dev.near.rpc.serializers.RpcCallFunctionErrorSerializer
import kotlin.String
import kotlin.ULong
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = RpcCallFunctionErrorSerializer::class)
public sealed class RpcCallFunctionError {
  @Serializable
  ...
  public data class ContractExecutionError(
    ...
    public data class InfoPayload(
      ...
      public val blockHeight: ULong,
      @SerialName("vm_error")
      public val vmError: FunctionCallError,
    )
