...
object RpcTransactionStatusRequestSerializer : KSerializer<RpcTransactionStatusRequest> {
    private val union: BlindUnionSerializer<RpcTransactionStatusRequest> = BlindUnionSerializer(
        ...
        variants = listOf(
            ...
            Variant(serialName = "sender_account_id_tx_hash", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcTransactionStatusRequest.SenderAccountIdTxHash }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcTransactionStatusRequest.SenderAccountIdTxHash>() as KSerializer<Any?>, fields = listOf("sender_account_id", "tx_hash", "wait_until"))
        )
    )
