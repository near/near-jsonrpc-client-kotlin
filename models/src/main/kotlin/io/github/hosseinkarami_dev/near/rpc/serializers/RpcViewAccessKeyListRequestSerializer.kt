...
object RpcViewAccessKeyListRequestSerializer : KSerializer<RpcViewAccessKeyListRequest> {
    ...
    override fun serialize(encoder: Encoder, value: RpcViewAccessKeyListRequest) = union.serialize(encoder, value)
    override fun deserialize(decoder: Decoder): RpcViewAccessKeyListRequest = union.deserialize(decoder)
}
