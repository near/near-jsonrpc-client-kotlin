...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcQueryErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcQueryErrorSerializer::class)
public sealed class ErrorWrapperForRpcQueryError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcQueryError,
    /**
