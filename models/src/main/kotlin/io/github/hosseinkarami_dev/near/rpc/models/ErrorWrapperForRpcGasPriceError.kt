...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcGasPriceErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcGasPriceErrorSerializer::class)
public sealed class ErrorWrapperForRpcGasPriceError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcGasPriceError,
    /**
