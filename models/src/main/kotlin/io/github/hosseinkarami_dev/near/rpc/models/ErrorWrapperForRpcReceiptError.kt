...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcReceiptErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcReceiptErrorSerializer::class)
public sealed class ErrorWrapperForRpcReceiptError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcReceiptError,
    /**
