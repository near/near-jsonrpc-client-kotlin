...
object RpcValidatorRequestSerializer : KSerializer<RpcValidatorRequest> {
    private val union: BlindUnionSerializer<RpcValidatorRequest> = BlindUnionSerializer(
        ...
        variants = listOf(
            Variant(serialName = "latest", kind = VariantKind.OBJECT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcValidatorRequest.Latest }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcValidatorRequest.Latest>() as KSerializer<Any?>, objectInstance = io.github.hosseinkarami_dev.near.rpc.models.RpcValidatorRequest.Latest),
