...
object RpcQueryResponseSerializer : KSerializer<RpcQueryResponse> {
    private val union: BlindUnionSerializer<RpcQueryResponse> = BlindUnionSerializer(
        ...
        variants = listOf(
            ...
            Variant(serialName = "Variant7", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcQueryResponse.Variant7 }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryResponse.Variant7>() as KSerializer<Any?>, fields = listOf("block_hash", "block_height"))
        )
    )
