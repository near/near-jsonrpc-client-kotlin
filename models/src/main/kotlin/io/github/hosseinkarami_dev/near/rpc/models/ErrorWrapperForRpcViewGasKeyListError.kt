...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcViewGasKeyListErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcViewGasKeyListErrorSerializer::class)
public sealed class ErrorWrapperForRpcViewGasKeyListError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcViewGasKeyListError,
    /**
