...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcLightClientNextBlockErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcLightClientNextBlockErrorSerializer::class)
public sealed class ErrorWrapperForRpcLightClientNextBlockError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcLightClientNextBlockError,
    /**
