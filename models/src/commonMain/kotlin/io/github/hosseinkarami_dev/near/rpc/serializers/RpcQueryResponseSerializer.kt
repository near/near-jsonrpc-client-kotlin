...
object RpcQueryResponseSerializer : KSerializer<RpcQueryResponse> {
    private val union: BlindUnionSerializer<RpcQueryResponse> = BlindUnionSerializer(
        ...
        variants = listOf(
            Variant(serialName = "AccountView", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcQueryResponse.AccountView }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryResponse.AccountView>() as KSerializer<Any?>, fields = listOf("amount", "bootstrap_nonce", "code_hash", "global_contract_account_id", "global_contract_hash", "locked", "state", "storage_paid_at", "storage_usage", "block_hash", "block_height")),
            ...
            Variant(serialName = "AccessKeyList", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcQueryResponse.AccessKeyList }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryResponse.AccessKeyList>() as KSerializer<Any?>, fields = listOf("keys", "last_key", "block_hash", "block_height")),
            Variant(serialName = "GasKeyNoncesView", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcQueryResponse.GasKeyNoncesView }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryResponse.GasKeyNoncesView>() as KSerializer<Any?>, fields = listOf("nonces", "block_hash", "block_height"))
        )
    )
