...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcNetworkInfoErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcNetworkInfoErrorSerializer::class)
public sealed class ErrorWrapperForRpcNetworkInfoError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcNetworkInfoError,
    /**
