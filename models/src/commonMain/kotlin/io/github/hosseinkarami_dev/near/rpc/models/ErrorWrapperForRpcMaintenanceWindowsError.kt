...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcMaintenanceWindowsErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcMaintenanceWindowsErrorSerializer::class)
public sealed class ErrorWrapperForRpcMaintenanceWindowsError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcMaintenanceWindowsError,
    /**
