...
object RpcReceiptToTxErrorSerializer : KSerializer<RpcReceiptToTxError> {
    private val union: BlindUnionSerializer<RpcReceiptToTxError> = BlindUnionSerializer(
        ...
        variants = listOf(
            ...
            Variant(serialName = "OUTCOMES_NOT_STORED", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcReceiptToTxError.OutcomesNotStored }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcReceiptToTxError.OutcomesNotStored>() as KSerializer<Any?>, fields = listOf("name")),
            Variant(serialName = "WINDOW_TOO_LARGE", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcReceiptToTxError.WindowTooLarge }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcReceiptToTxError.WindowTooLarge>() as KSerializer<Any?>, fields = listOf("info", "name")),
            Variant(serialName = "MALFORMED_HINT", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcReceiptToTxError.MalformedHint }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcReceiptToTxError.MalformedHint>() as KSerializer<Any?>, fields = listOf("info", "name")),
            Variant(serialName = "BUDGET_EXCEEDED", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcReceiptToTxError.BudgetExceeded }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcReceiptToTxError.BudgetExceeded>() as KSerializer<Any?>, fields = listOf("info", "name"))
        )
    )
