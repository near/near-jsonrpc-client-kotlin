...
object RpcLightClientProofErrorSerializer : KSerializer<RpcLightClientProofError> {
    private val union: BlindUnionSerializer<RpcLightClientProofError> = BlindUnionSerializer(
        ...
        variants = listOf(
            ...
            Variant(serialName = "SHARD_NOT_TRACKED", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcLightClientProofError.ShardNotTracked }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcLightClientProofError.ShardNotTracked>() as KSerializer<Any?>, fields = listOf("info", "name")),
            Variant(serialName = "TARGET_SHARD_MISMATCH", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcLightClientProofError.TargetShardMismatch }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcLightClientProofError.TargetShardMismatch>() as KSerializer<Any?>, fields = listOf("info", "name")),
            Variant(serialName = "STATE_NOT_AVAILABLE", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcLightClientProofError.StateNotAvailable }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcLightClientProofError.StateNotAvailable>() as KSerializer<Any?>, fields = listOf("info", "name")),
