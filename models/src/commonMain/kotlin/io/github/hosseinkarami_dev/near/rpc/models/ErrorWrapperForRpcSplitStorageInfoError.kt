...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcSplitStorageInfoErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcSplitStorageInfoErrorSerializer::class)
public sealed class ErrorWrapperForRpcSplitStorageInfoError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcSplitStorageInfoError,
    /**
