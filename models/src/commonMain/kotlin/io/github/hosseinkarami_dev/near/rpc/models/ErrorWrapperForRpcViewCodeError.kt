...
import io.github.hosseinkarami_dev.near.rpc.serializers.ErrorWrapperForRpcViewCodeErrorSerializer
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = ErrorWrapperForRpcViewCodeErrorSerializer::class)
public sealed class ErrorWrapperForRpcViewCodeError {
  @Serializable
  ...
  public data class HandlerError(
    @SerialName("cause")
    public val cause: RpcViewCodeError,
    /**
