...
object RpcTransactionErrorSerializer : KSerializer<RpcTransactionError> {
    private val union: BlindUnionSerializer<RpcTransactionError> = BlindUnionSerializer(
        ...
        variants = listOf(
            ...
            Variant(serialName = "TIMEOUT_ERROR", kind = VariantKind.DEFAULT, isInstance = { it is io.github.hosseinkarami_dev.near.rpc.models.RpcTransactionError.TimeoutError }, fullSerializer = serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcTransactionError.TimeoutError>() as KSerializer<Any?>, fields = listOf("info", "name"))
        )
    )
